 ...
 *
 * - method, requestURL, urlParts, async, user, password
 * - requestText
 *
...
//        oReq.addEventListener("abort", this.onabort, false);
  ...
  passthrough: function () {
    ...
    function Request () {
      ...
      var orgRequestHeader = req.setRequestHeader;
      req.setRequestHeader = function(name, value) {
        this.requestHeaders[name.toLowerCase()] = value;
        orgRequestHeader.apply(this, arguments);
      };

      var orgOpen = req.open;
